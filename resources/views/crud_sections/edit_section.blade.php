        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-300">
                    <form action="../update_section/{{ $sections->id }}" method="POST">
                        
                        @method('PUT')
                        @csrf

                        <label for="section_name">Section Name:</label>
                        <input type="text" name="section_name" value = "{{ $sections->section_name }}"
                            class="mt-8 sm:ml-12" required>
                        <br>
                        <label for="section_description">Section Description: </label>
                        <input type="text" name="section_description" value ="{{ $sections->section_description }}"
