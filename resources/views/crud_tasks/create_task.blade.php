            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-300">
                    <form action="store_task" method="POST">
                        ...
                        <input type="text" name="task_name" placeholder="Task Name: " class="mt-8 sm:ml-12" required>
                        <br>
                        <label for="task_description">Task Description: </label>
                        <input type="text" name="task_description" placeholder="Description: " class="mt-8 ml-2 sm:h-16 sm:w-96" required>
                        <br>
